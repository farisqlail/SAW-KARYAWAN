...
>>>>>>> f69eed811610c99c8c3443472b69372722deab47
        ...
        <div class="card" style="width: 67rem;">
            <div class="card-body">
                ...
                <div class="pdf mt-4" style="margin: -10px; " align="center">
                    <embed src="{{ asset('storage/file/cv/' . $pelamar->cv) }}" type="application/pdf" height="760px" width="80%">
                </div>
            </div>
        </div>
        ...
        <div class="card" style="width: 67rem;">
            <div class="card-body">
                ...
                <div class="pdf mt-4" style="margin: -10px; " align="center">
                    <embed src="{{ asset('storage/file/ijazah/' . $pelamar->ijazah) }}" type="application/pdf" height="760px" width="80%">
                </div>
