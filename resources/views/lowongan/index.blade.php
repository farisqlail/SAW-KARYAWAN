                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{route('lowongan.hapus',['id' => $data->id_lowongan])}}" method="POST">
                                            ...
                                            <a href="{{route('kriteria.index',['id' => $data->id_lowongan])}}" class="btn btn-sm btn-info">Kriteria</a>
                                            <a href="{{route('lowongan.edit',['id' => $data->id_lowongan])}}" class="btn btn-sm btn-warning">Edit</a>
